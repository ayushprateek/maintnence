...
class TripExecutionLookup extends StatefulWidget {
  Function(OPOTRE) onSelection;

  TripExecutionLookup({super.key, required this.onSelection});

  @override
  State<TripExecutionLookup> createState() => _TripExecutionLookupState();
}

class _TripExecutionLookupState extends State<TripExecutionLookup> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
              future: retrieveOPOTREForDisplay(
                  dbQuery: _query.text, limit: _currentMax),
              builder:
                  (BuildContext context, AsyncSnapshot<List<OPOTRE>> snapshot) {
                if (snapshot.hasData) {
