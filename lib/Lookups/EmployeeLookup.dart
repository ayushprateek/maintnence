...
class EmployeeLookup extends StatefulWidget {
  Function(OEMPModel) onSelection;

  EmployeeLookup({super.key, required this.onSelection});

  @override
  State<EmployeeLookup> createState() => _EmployeeLookupState();
}

class _EmployeeLookupState extends State<EmployeeLookup> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
                future: retrieveOEMPForSearch(
                    query: _query.text, limit: _currentMax),
                builder: (context, AsyncSnapshot<List<OEMPModel>> snapshot) {
