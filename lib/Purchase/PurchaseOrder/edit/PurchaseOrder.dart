...
class EditPurchaseOrder extends StatefulWidget {
  ...
  EditPurchaseOrder(int index, {this.onBackPressed}) {
    this.index = index;
  }
...
class _JobCardState extends State<EditPurchaseOrder> {
  @override
  void initState() {
    super.initState();
  }
  ...
  save() async {
    ...
    EditPurchaseOrder.saveButtonPressed = false;
        ...
        if (!EditPurchaseOrder.saveButtonPressed) {
          ...
          try {
            await db.transaction((database) async {
              ...
              getSuccessSnackBar("Purchase Order Updated Successfully");
