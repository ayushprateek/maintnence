...
class SearchPurchaseOrder extends StatefulWidget {
  const SearchPurchaseOrder({super.key});

  @override
  State<SearchPurchaseOrder> createState() => _SearchPurchaseOrderState();
}

class _SearchPurchaseOrderState extends State<SearchPurchaseOrder> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
                future: retrievePROPORForSearch(
                    query: TransId.text, limit: _currentMax),
                builder: (context, AsyncSnapshot<List<PROPOR>> snapshot) {
