...
class _ViewCheckListDocumentState extends State<ViewCheckListDocument> {
  ...
  save() async {
    ...
    ViewCheckListDocument.saveButtonPressed = false;
    if (DataSync.isSyncing()) {
      ...
      if (!GeneralData.validate()) {
        ...
        if (!ViewCheckListDocument.saveButtonPressed) {
          ViewCheckListDocument.saveButtonPressed = true;
          showLoader(context);
          ...
          try {
            await db.transaction((database) async {
              ...
              if (!GeneralData.isSelected) {
                if (ViewCheckListDocument.approvalModel?.Add == true &&
                    ViewCheckListDocument.approvalModel?.Active == true) {
