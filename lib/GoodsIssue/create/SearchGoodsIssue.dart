...
class SearchGoodsIssue extends StatefulWidget {
  const SearchGoodsIssue({super.key});

  @override
  State<SearchGoodsIssue> createState() => _SearchGoodsIssueState();
}

class _SearchGoodsIssueState extends State<SearchGoodsIssue> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
                future: retrieveIMOGDIForSearch(
                    query: TransId.text, limit: _currentMax),
                builder: (context, AsyncSnapshot<List<IMOGDI>> snapshot) {
