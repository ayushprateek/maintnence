                              ...
                              Row(
                                children: [
                                  Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          navigateToGoodsReceiptNoteDocument(TransId: snapshot.data![index].TransId??'',isView: true);
                                        },
                                  ...
                                  Expanded(
                                      child: InkWell(
                                        onTap: () {
                                          navigateToGoodsReceiptNoteDocument(TransId: snapshot.data![index].TransId??'',isView: false);
                                        },
                                        child: getPoppinsText(
                                            text: 'Edit',
                                            color: Colors.red,
