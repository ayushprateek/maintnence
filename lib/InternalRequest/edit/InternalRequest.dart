...
class EditInternalRequest extends StatefulWidget {
  static bool saveButtonPressed = false;
  int index = 0;

  EditInternalRequest(int index, {this.onBackPressed}) {
    this.index = index;
  }
  ...
  @override
  EditInternalRequestState createState() => EditInternalRequestState();
}
