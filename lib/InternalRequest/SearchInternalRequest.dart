...
class SearchInternalRequest extends StatefulWidget {
  const SearchInternalRequest({super.key});

  @override
  State<SearchInternalRequest> createState() => _SearchInternalRequestState();
}

class _SearchInternalRequestState extends State<SearchInternalRequest> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            FutureBuilder(
                future: retrievePROITRForSearch(
                    query: TransId.text, limit: _currentMax),
                builder: (context, AsyncSnapshot<List<PROITR>> snapshot) {
                      ...
                      return InkWell(
                        onDoubleTap: () {
                          navigateToInternalRequestDocument(
                              TransId: snapshot.data![index].TransId ?? '');
                        },
                        child: Container(
