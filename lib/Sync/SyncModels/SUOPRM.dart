...
class SUOPRM {
  ...
  factory SUOPRM.fromJson(Map<String, dynamic> json) =>
      SUOPRM(
...
Future<void> updateSUOPRM(int id, Map<String, dynamic> values,
...
Future<List<SUOPRM>> retrieveSUOPRMById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
