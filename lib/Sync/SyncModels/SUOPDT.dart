...
class SUOPDT {
  ...
  factory SUOPDT.fromJson(Map<String, dynamic> json) =>
      SUOPDT(
...
Future<void> updateSUOPDT(int id, Map<String, dynamic> values,
...
Future<List<SUOPDT>> retrieveSUOPDTById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
