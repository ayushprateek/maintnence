...
class IUOM {
  ...
  factory IUOM.fromJson(Map<String, dynamic> json) =>
      IUOM(
...
Future<void> updateIUOM(int id, Map<String, dynamic> values,
...
Future<List<IUOM>> retrieveIUOMById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
