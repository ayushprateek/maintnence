...
class DLN3Model {
  ...
  factory DLN3Model.fromJson(Map<String, dynamic> json) =>
      DLN3Model(
...
Future<void> updateDLN3(int id, Map<String, dynamic> values,
...
//SEND DATA TO SERVER
//--------------------------
Future<List<DLN3Model>> retrieveDLN3ById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
  ...
  if (TransId != null) {
    ...
    do {Map<String, dynamic> map = list[i].toJson();
      ...
      try {
        ...
        var res = await http.post(Uri.parse(prefix + "DLN3/Add?$queryParams"),
