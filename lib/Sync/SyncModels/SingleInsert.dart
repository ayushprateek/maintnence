...
SingleInsert singleInsertFromJson(String str) => SingleInsert.fromJson(json.decode(str));
...
class SingleInsert {
  ...
  factory SingleInsert.fromJson(Map<String, dynamic> json) => SingleInsert(
    mnoclDs: json["MNOCLDs"] == null ? [] : List<MNOCLD>.from(json["MNOCLDs"]!.map((x) => MNOCLD.fromJson(x))),
    mncld1S: json["MNCLD1s"] == null ? [] : List<MNCLD1>.from(json["MNCLD1s"]!.map((x) => MNCLD1.fromJson(x))),
    mncld2S: json["MNCLD2s"] == null ? [] : List<MNCLD2>.from(json["MNCLD2s"]!.map((x) => MNCLD2.fromJson(x))),
    mncld3S: json["MNCLD3s"] == null ? [] : List<MNCLD3>.from(json["MNCLD3s"]!.map((x) => MNCLD3.fromJson(x))),
    mnojcDs: json["MNOJCDs"] == null ? [] : List<MNOJCD>.from(json["MNOJCDs"]!.map((x) => MNOJCD.fromJson(x))),
    ...
    prprq1S: json["PRPRQ1s"] == null ? [] : List<PRPRQ1>.from(json["PRPRQ1s"]!.map((x) => PRPRQ1.fromJson(x))),
    propdNs: json["PROPDNs"] == null ? [] : List<PROPDN>.from(json["PROPDNs"]!.map((x) => PROPDN.fromJson(x))),
    prpdn1S: json["PRPDN1s"] == null ? [] : List<PRPDN1>.from(json["PRPDN1s"]!.map((x) => PRPDN1.fromJson(x))),
    prpdn2S: json["PRPDN2s"] == null ? [] : List<PRPDN2>.from(json["PRPDN2s"]!.map((x) => PRPDN2.fromJson(x))),
    prpdn3S: json["PRPDN3s"] == null ? [] : List<PRPDN3>.from(json["PRPDN3s"]!.map((x) => PRPDN3.fromJson(x))),
    proitRs: json["PROITRs"] == null ? [] : List<PROITR>.from(json["PROITRs"]!.map((x) => PROITR.fromJson(x))),
    pritr1S: json["PRITR1s"] == null ? [] : List<PRITR1>.from(json["PRITR1s"]!.map((x) => PRITR1.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "MNOCLDs": mnoclDs == null ? [] : List<dynamic>.from(mnoclDs!.map((x) => x.toJson())),
    "MNCLD1s": mncld1S == null ? [] : List<dynamic>.from(mncld1S!.map((x) => x.toJson())),
    "MNCLD2s": mncld2S == null ? [] : List<dynamic>.from(mncld2S!.map((x) => x.toJson())),
    "MNCLD3s": mncld3S == null ? [] : List<dynamic>.from(mncld3S!.map((x) => x.toJson())),
    "MNOJCDs": mnojcDs == null ? [] : List<dynamic>.from(mnojcDs!.map((x) => x.toJson())),
    ...
    "PRPRQ1s": prprq1S == null ? [] : List<dynamic>.from(prprq1S!.map((x) => x.toJson())),
    "PROPDNs": propdNs == null ? [] : List<dynamic>.from(propdNs!.map((x) => x.toJson())),
    "PRPDN1s": prpdn1S == null ? [] : List<dynamic>.from(prpdn1S!.map((x) => x.toJson())),
    "PRPDN2s": prpdn2S == null ? [] : List<dynamic>.from(prpdn2S!.map((x) => x.toJson())),
    "PRPDN3s": prpdn3S == null ? [] : List<dynamic>.from(prpdn3S!.map((x) => x.toJson())),
    "PROITRs": proitRs == null ? [] : List<dynamic>.from(proitRs!.map((x) => x.toJson())),
    "PRITR1s": pritr1S == null ? [] : List<dynamic>.from(pritr1S!.map((x) => x.toJson())),
  };
}
