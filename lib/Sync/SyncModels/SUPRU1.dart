...
class SUPRU1 {
  ...
  factory SUPRU1.fromJson(Map<String, dynamic> json) =>
      SUPRU1(
...
Future<void> updateSUPRU1(int id, Map<String, dynamic> values,
...
Future<List<SUPRU1>> retrieveSUPRU1ById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
