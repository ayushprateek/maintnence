...
class RTN3Model {
  ...
  factory RTN3Model.fromJson(Map<String, dynamic> json) => RTN3Model(
...
//SEND DATA TO SERVER
//--------------------------
Future<List<RTN3Model>> retrieveRTN3ById(
  ...
  if (TransId != null) {
    ...
    do {
      ...
      try {
        ...
        var res = await http
            .post(Uri.parse(prefix + "RTN3/Add?$queryParams"),
