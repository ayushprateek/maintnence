...
class QUT3Model {
  ...
  factory QUT3Model.fromJson(Map<String, dynamic> json) =>
      QUT3Model(
...
Future<void> updateQUT3(int id, Map<String, dynamic> values,
...
//SEND DATA TO SERVER
//--------------------------
Future<List<QUT3Model>> retrieveQUT3ById(BuildContext? context, String str,
    List l) async {
  final Database db = await initializeDB(context);
  ...
  if (TransId != null) {
    ...
    do {Map<String, dynamic> map = list[i].toJson();
      ...
      try {
        ...
        var res = await http.post(Uri.parse(prefix + "QUT3/Add?$queryParams"),
        ...
        if(res.statusCode ==409)
        {
          ...
          var x = await db.update("QUT3", model.toJson(),
