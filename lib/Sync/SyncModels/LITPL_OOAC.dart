...
class LITPL_OOAC {
  ...
  factory LITPL_OOAC.fromJson(Map<String, dynamic> json) =>
      LITPL_OOAC(
...
Future<void> updateLITPL_OOAC(int id, Map<String, dynamic> values,
...
Future<List<LITPL_OOAC>> retrieveLITPL_OOACById(BuildContext? context,
